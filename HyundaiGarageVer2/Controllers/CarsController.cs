...
namespace HyundaiGarageVer2.Controllers
{
    public class CarsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarID,Model,ManufYear,CustomerID")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarID,Model,ManufYear,CustomerID")] Car car)
        {
            if (ModelState.IsValid)
            {
